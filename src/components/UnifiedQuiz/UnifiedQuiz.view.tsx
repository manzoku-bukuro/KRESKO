...
import type { QuizQuestion, QuizMode, WordDisplay } from '@/types'

export interface UnifiedQuizViewProps {
  // Props from parent
  metadata: UnifiedQuizProps['metadata']
  completionConfig?: UnifiedQuizProps['completionConfig']
  loading?: UnifiedQuizProps['loading']
  loadingConfig?: UnifiedQuizProps['loadingConfig']
  error?: UnifiedQuizProps['error']
  errorConfig?: UnifiedQuizProps['errorConfig']
  ...
  // Computed values
  traditionalWordDisplay: WordDisplay
  choiceWordDisplay: WordDisplay
  ...
  handleBack: () => void
  getFilteredActions: (condition: string) => UnifiedQuizProps['customActions']
}

export const UnifiedQuizView = ({
  metadata,
  completionConfig,
  loading,
  loadingConfig,
